...
<script>
    ...
    function displaySelectedOption() {
        ...
        if (!selectedOptionIds.includes(selectedOptionId)) {
            ...
            newOptionDiv.innerHTML = selectedOptionName;
    ...
    function showSelectedOptions() {
        ...
        for (var i = 0; i < selectedOptionIds.length; i++) {
            var selectedOptionId = selectedOptionIds[i];
            var selectedOptionName = document.querySelector("#idinputkf option[value='" + selectedOptionId + "']").text;
...
<script>
    var selectedOptions = [];
    var selectedOptionsUl = document.getElementById("selectedOptions");
    ...
    function displaySelectedOption() {
        ...
        if (!selectedOptions.includes(selectedOptionId)) {
            ...
            newOptionLi.innerHTML = selectedOptionName;
            selectedOptionsUl.appendChild(newOptionLi);
        }
    }
    ...
    function showSelectedOptions() {
        ...
        for (var i = 0; i < selectedOptions.length; i++) {
            ...
            var selectedOptionName = document.querySelector(`option[value="${selectedOptionId}"]`).text;
            message += selectedOptionName + "\n";
        }
        alert(message);
    }
