            ...
            <ul class="nav_bar-item-right">
                @if (Session::has('user'))
                    <div class="dropdown">
                        ...
                        <button class="btn-login px-3 dropdown-toggle" type="button" data-toggle="dropdown"
                            style="background-color: white; color: black; width: auto;">
                            <i class="fa-solid fa-user"></i> {{ Session('user')->Name }}
                            <span class="caret"></span></button>
                        </button>
                        <ul class="dropdown-menu">
                            <li><a href="#"><i class="fa-solid fa-list-check mx-2"></i> Order</a></li>
                            <li data-toggle="modal" data-target="#btncreateshop"><a><i
                                        class="fa-solid fa-store mx-2"></i> Your shop</a></li>
        ...
        <div class="bar">
            ...
            <div class="listbar" id="listbar">
                <li class="d-flex justify-content-between">
                    <a href="#"><span class="icon_header_body fa-solid fa-heart"
                            style="color: white;"></span>Storage</a>
                    <button class="btn-close" onclick="closeListbar()"></button>
                </li>

                <a href="{{ route('cart') }}"><span class="icon_header_body fa-solid fa-cart-shopping"></span>
                    Cart</a>
                </li>
                <li class="icon-user">
...
<div class="modal fade" id="btncreateshop" tabindex="-1" role="dialog" aria-labelledby="btn1Title"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                @include('error')
                <form action="{{ route('createShop') }}" method="post" class="login-form w-100"
                    enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <label for='avatar'>Name shop</label>
                        <input type="text" class="auth-form-input w-100" placeholder="Name" id="name"
                            name="name">
                    </div>
                    <div class="form-group">
                        <label for='avatar'>Description shop</label>
                        <input type="area" class="auth-form-input w-100" placeholder="Description"
                            id="description" name="description" required>
                    </div>
                    <div class="form-group">
                        <label for='avatar'>Location shop</label>
                        <input type="text" class="auth-form-input w-100" placeholder="Location" id="location"
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" class="auth-form-input w-100" name="coverImage" id="coverImage"
                            required>
                    </div>
