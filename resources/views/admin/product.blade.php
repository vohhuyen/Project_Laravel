    ...
    <div class="page" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
            ...
            <div>
                <div class="brand-logo">
                    <a href="./index.html" class="text-nowrap logo-img">
                        <img src="source/admin/assets/images/logos/logo.png" width="200"
                            style="margin-left: 10px; margin-top: 3px;" alt="" />
                    </a>
                </div>
                <!-- Sidebar navigation-->
        ...
        <div class="body-content">
            ...
            <header class="app-header">
                ...
                <button class="addproducts" data-toggle="modal" data-target="#btn1">Create <i
            ...
            <div class="modal fade" id="btn1" tabindex="-1" role="dialog" aria-labelledby="btn1Title"
                aria-hidden="true">
                        ...
                        <div class="modal-body row">
                            <form action="admin-add-form" method="post" enctype="multipart/form-data"
                                ...
                                <div class="form-group">
                                    ...
                                    <br>
                                    <select onchange="myfunction(this)" id="categories" name="categories" class="inputAddUser">
                                        @foreach ($category_pr as $category_pr)
                                            <option value="{{ $category_pr->idCategoryPrDetail }}">
                                                {{ $category_pr->nameCategoryPrDetail }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <pre></pre>
                                ...
                                <div class="form-group">
                                    ...
                                    <select onchange="myfunction(this)" id="name_product" name="name_product" class="inputAddUser">
                                        @foreach ($originalproducts as $originalproducts)
                                            <option value="{{ $originalproducts->nameOPr }}">
                                                {{ $originalproducts->nameOPr }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <pre></pre>
                                <div class="form-group">
                                    ...
                                    <br>
                                    <select id="provider" name="provider" class="inputAddUser">
                                        @foreach ($providers as $providers)
                                            <option value="{{ $providers->idProvider }}">{{ $providers->Name }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <br>
                                    <select id="color" name="color" class="inputAddUser">
                                        @foreach ($color as $val)
                                            <option value=" {{ $val->idColor }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <br>
                                    <input type="file" class="form-control-file inputAddUser" id="productImage"
                                    ...
                                    <script type="text/javascript">
                                        $(document).ready(function(e) {
                                            $('#productImage').change(function() {
                                                ...
                                                reader.onload = (e) => {
                                                    $('#preview-image-before-upload').attr('scr', e.target.result);
                                                }
                                ...
                                <div class="form-group">
                                    ...
                                    <br>
                                    <input type="text" class="form-control-file inputAddUser" id="NameDesign"
                                        name="NameDesign">
                                </div>
                                <pre></pre>
                                ...
                                <div class="form-group">
                                    ...
                                    <br>
                                    <input type="number" class="inputAddUser" id="productPrice" name="productPrice"
                                        placeholder="> price original product">
                                </div>
                                <pre></pre>
                                <div class="form-group">
                            ...
                            <tbody>
                                @foreach ($products as $product)
                                    <tr style="height:200px">
                                        <td
                                            style="width:3%;display:flex;align-items:center;justify-content: center;height:200px;vertical-align: middle;">
                                            {{ $product->idProduct }}</td>
                                        <td style="width:9%;height:200px;vertical-align: middle;"><img
                                                src="source/imageOPr/{{ $product->imagePr }}" alt="product1"
                                                style="width: 100px;height: 100px;margin-top:10px"></td>
                                        <td style="width:13%;height:200px;vertical-align: middle;">
                                            {{ $product->namePr }}</td>
                                        <td style="width:9%;height:200px;vertical-align: middle;">
                                            {{ $product->pricePr }} USD</td>
                                        @include('admin.color')
                                        <td style="width:15%;height:200px;vertical-align: middle;"><img
                                                src="source/imageOPr/{{ $product->imageDesign }}"
                                                style="width: 60px;height: 60px;"></td>
                                        <td style="width:9%;height:200px;vertical-align: middle;">
                                            {{ $product->Name }}
                                        </td>
                                        <td style="width:100%;height:200px;vertical-align: middle;">
                                            {{ $product->descriptionDesign }}</td>
                                        <td style="width:9%;height:200px;vertical-align: middle;">{{ $product->note }}
                                        </td>
                                        <td style="width:7%;height:200px;vertical-align: middle;"><button
    ...
    function myfunction(event){ 
        ...
        $.ajax({
                ...
                success: function (data) {
                    console.log(data);
                    var selectOptions = $('#name_product');
                    selectOptions.empty();

                    $.each(data.data, function (key, value) {
                    selectOptions.append('<option value="' + value.namePr + '">' + value.namePr + '</option>');
                });
                },
