                ...
                <div class="auth-form-outer">
                    ...
                    @csrf 
                        ...
                        <div class="input-icon">
                            <input type="password" id="passwordInput" class="auth-form-input" placeholder="Password" id="password" name="password">
                        ...
                        <label class="active">
                            ...
                            <span> I agree to the <a data-toggle="modal" data-target="#error">Terms</a> and <a data-toggle="modal" data-target="#error">Privacy Policy</a>.</span>
                        </label>
